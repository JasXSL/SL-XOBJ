...
// Uncomment this if you need root to accept events. You'll want to create an onEvt(string script, integer evt, list data) function
//#define USE_EVENTS
...
timerEvent(string id, string data){
    if(llGetSubString(id, 0, 1) == "H_"){
        // l2i is libJasPre macro for llList2Integer
        list datarr = llJson2List(data);
        integer d = l2i(datarr, 0);
        d++;
        // Lists defined within macros have to be wrapped in ()
...
default 
{
    ...
    state_entry()
    {
        // If you use the RLV supportcube, wipe all old ones
    ...
    */ 
    ...
    if(method$internal){
        // If you have a RootMethod$statusControls defined in your #ROOT.lsl file
        /*
