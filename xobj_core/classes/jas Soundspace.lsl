/*
	...
	4. Create a new script in the same prim as st Soundspace, name it "jas SoundspaceAux"
...
#define Soundspace$dive(submerged) runMethod((string)LINK_ALL_OTHERS, "jas Soundspace", SoundspaceMethod$dive, [submerged], TNN)
